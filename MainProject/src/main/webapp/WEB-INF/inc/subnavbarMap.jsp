...
<body>
	<div class="sub-nav-bar">
		<ul class="sub-nav-list">
			...
			<li class="sub-nav-item"><a href="#" class="active"> 지도 <span
					class="arrow-icon">&#9662;</span>
			</a>
				<div class="sub-nav-dropdown-menu">
					<a href="${pageContext.request.contextPath}/inputView"
						class="sub-nav-dropdown-item">제로 에너지 건축물 등급 측정</a> <a
						href="${pageContext.request.contextPath}/mapView"
						class="sub-nav-dropdown-item">지도 상세보기</a> <a
						href="${pageContext.request.contextPath}/infoBoardView"
						class="sub-nav-dropdown-item">에너지 관련 정보</a>
				</div></li>
		</ul>
	</div>
	<script>
