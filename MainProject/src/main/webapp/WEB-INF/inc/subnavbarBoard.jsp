...
<body>
	<div class="sub-nav-bar">
		<ul class="sub-nav-list">
			...
			<li class="sub-nav-item"><a href="#" class="active"> 게시판 <span
					class="arrow-icon">&#9662;</span>
			</a>
				<div class="sub-nav-dropdown-menu">
					<a href="${pageContext.request.contextPath}/noticeBoardView"
						class="sub-nav-dropdown-item">공지사항</a> <a
						href="${pageContext.request.contextPath}/reviewView"
						class="sub-nav-dropdown-item">리뷰게시판</a> <a
						href="${pageContext.request.contextPath}/freeBoardView"
						class="sub-nav-dropdown-item">자유게시판</a> <a
						href="${pageContext.request.contextPath}/productView"
						class="sub-nav-dropdown-item">에너지 효율 제품 게시판</a>
				</div></li>
		</ul>
	</div>
	<script>
