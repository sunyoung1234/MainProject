...
public class EnergyUsedDTO {
    ...
    private String saveCo2;
    private String saveWood;
	...
	public EnergyUsedDTO(String memId, String buildingId, String elecUse, String gasUse, String solarEnergyProduction,
			...
			String saveCo2, String saveWood) {
		super();
		this.memId = memId;
	...
	public String toString() {
		return "EnergyUsedDTO [memId=" + memId + ", buildingId=" + buildingId + ", elecUse=" + elecUse + ", gasUse="
				...
				+ ", saveCo2=" + saveCo2 + ", saveWood=" + saveWood + "]";
	}
	...
	public String getSaveWood() {
		return saveWood;
	}


	public void setSaveWood(String saveWood) {
		this.saveWood = saveWood;
	}
