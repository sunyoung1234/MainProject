...
public class ProposalDTO {
    ...
    public ProposalDTO(String memId, String memName, int propNo, String propId, Date propDate, String propTitle, String propContent,
                       String propDelYn, String propStatus) {
        super();
        this.memId = memId;
    ...
    public Date getPropDate() { return propDate; } 
    public void setPropDate(Date propDate) { this.propDate = propDate; }
    public String getPropTitle() { return propTitle; }
    public void setPropTitle(String propTitle) { this.propTitle = propTitle; }
    ...
    public String getPropDelYn() { return propDelYn; }
    public void setPropDelYn(String propDelYn) { this.propDelYn = propDelYn; }
